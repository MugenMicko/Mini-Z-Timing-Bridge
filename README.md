...
BOM
2 x 490mm long 2020 Aluminium Extrusion with both ends tapped for M5 BHCS (Uprights) (these can be reduced to 270mm for trackmate system)
2 x 400mm long 2020 Aluminium Extrusion with both ends tapped for M5 BHCS and a central hole of 5mm drilled through for the blind joint faster (Bottom)
1 x 1006mm long 2020 Aluminium Extrusion with 2 5mm holes drilled through 10mm from each end of the extrusion in the same direction to facilitate blind joint faster (Cross Beam)
10 x M5 Roll In Spring T Nuts
14 x M5 x 10 BHCS
10 x M5 Washers
4 x M5 x 12 BHCS (10mm version will also work)
6 x M3 x 14 BHCS
2 x M3 x 8 BHCS
8 x M3 Washers
2 x Laser cut brackets (braket V4 for Easylaps, Small Bracket for TrackMate)
3D printed parts for protectors and EasyLaps Interface holder (Optional items)
