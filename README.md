...
The system has been tested successfully with an EasyLaps system with out local club and found to resolve any missed lap issues we have had.\
The plastic covers on the corner of the cross beam and feet are only there to protect people and objects from potential sharp edges and are NOT structural.\

##BOM
1. 2 x 490mm long 2020 Aluminium Extrusion with both ends tapped for M5 BHCS (Uprights) (these can be reduced to 270mm for trackmate system)
2. 2 x 400mm long 2020 Aluminium Extrusion with both ends tapped for M5 BHCS and a central hole of 5mm drilled through for the blind joint faster (Bottom)
3. 1 x 1006mm long 2020 Aluminium Extrusion with 2 5mm holes drilled through 10mm from each end of the extrusion in the same direction to facilitate blind joint faster (Cross Beam)
4. 10 x M5 Roll In Spring T Nuts
5. 14 x M5 x 10 BHCS
6. 10 x M5 Washers
7. 4 x M5 x 12 BHCS (10mm version will also work)
8. 6 x M3 x 14 BHCS
9. 2 x M3 x 8 BHCS
10. 8 x M3 Washers
11. 2 x Laser cut brackets (braket V4 for Easylaps, Small Bracket for TrackMate)
12. 3D printed parts for protectors and EasyLaps Interface holder (Optional items)

I was able to get my brackets cut through a local supplier but I have also confirmed the bracket cutting files are compatible with SendCutSend, JLCPCB and PCBWay if you have noone local to you to cut them
I was able to order extrusion cut to length from a supplier in Melboure, there are a variety of resellers of 2020 extrusion all over the work including the likes of Mitsumi etc
